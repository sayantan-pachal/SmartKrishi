...
function Fields() {
    ...
    const handleSaveField = useCallback(async (formData) => {
        ...
        if (editingField) {
            ...
            // Replace Appwrite string generation with the custom ID generation system
            ...
            <div className="max-w-6xl mx-auto">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-5 py-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-2xl shadow-md transition-all active:scale-95 text-sm"
                    >
                        <Plus size={18} />
                        Add New Field
                    </button>
                    ...
                    {filteredFields.length === 0 && (
                        <div className="col-span-full py-24 text-center">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                {searchTerm ? "No fields match your search." : "No fields yet. Add one to get started!"}
                            </p>
                        </div>
                    )}
                </div>
