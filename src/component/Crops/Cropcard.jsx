...
const CropCard = React.memo(({ crop, onEdit, onDelete }) => {
    ...
    return (
        <div className="box group relative bg-white dark:bg-white/[0.03] border border-black/6 dark:border-white/6 rounded-[2rem] hover:border-smart-green-300 dark:hover:border-smart-green-800 hover:shadow-xl hover:shadow-smart-green-900/5 transition-all duration-300 overflow-hidden flex flex-col h-full font-dm">
            ...
            <div className="relative h-48 overflow-hidden bg-gray-100 dark:bg-white/[0.02] border-b border-black/5 dark:border-white/5">
                ...
                <div className="absolute top-5 right-5 flex gap-2">
                    <span className={`flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] uppercase tracking-widest font-bold backdrop-blur-md ${crop.status === "Healthy"
