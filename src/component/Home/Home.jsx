  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#050505] font-dm text-gray-900 dark:text-gray-100 selection:bg-smart-green-500 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10 flex justify-between items-center">
          ...
          <div className="flex items-center gap-8 text-sm font-semibold">
            ...
            <Link to="/signup" className="hidden md:flex group relative px-6 py-2.5 hover:dark:text-white bg-gray-900 dark:bg-white text-white dark:text-black rounded-full overflow-hidden shadow-lg hover:shadow-xl transition-all ">
              <div className="absolute inset-0 w-full h-full bg-smart-green-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      ...
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden px-6">
        {/* Abstract Glows */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-smart-green-500/20 dark:bg-smart-green-500/10 blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <h1 className="font-fraunces font-black text-6xl md:text-8xl tracking-tight leading-[1.1] mb-6 text-gray-900 dark:text-white">
            {hero.title} <br />
            <span className="relative inline-block mt-2">
              <span className="relative z-10 bg-gradient-to-r from-smart-green-600 to-emerald-400 bg-clip-text text-transparent">
                {hero.highlight}
              </span>
              <div className="absolute -bottom-2 left-0 w-full h-3 bg-smart-green-500/20 dark:bg-smart-green-500/30 -z-10 -rotate-1" />
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a href="#features" className="w-full sm:w-auto px-8 py-4 rounded-2xl border-2 border-gray-200 dark:border-gray-800 font-bold hover:border-gray-300 dark:hover:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 transition-all">
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-24">
        <div className="text-center mb-16">
          ...
          <h2 className="font-fraunces font-black text-4xl md:text-5xl tracking-tight max-w-2xl mx-auto">Everything your farm needs, beautifully integrated.</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[280px]">
          {features?.map((feature, i) => (
            ...
            >
              <div className="absolute top-0 right-0 p-8 opacity-10 group-hover:opacity-20 group-hover:scale-110 group-hover:-translate-y-2 transition-all duration-500">
                <feature.Icon className="w-32 h-32 text-smart-green-600" />
              </div>
              <div className="relative z-10 h-full flex flex-col justify-end">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-6 shadow-sm ${feature.bgColor || 'bg-gray-100 dark:bg-gray-800'} ${feature.color || 'text-gray-900 dark:text-white'}`}>
      ...
      <section id="about" className="max-w-7xl mx-auto px-6 py-32 border-t border-gray-200 dark:border-gray-800">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div className="order-2 lg:order-1 relative h-[500px] w-full rounded-[3rem] bg-gray-100 dark:bg-gray-900 overflow-hidden group">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="font-fraunces font-black text-4xl md:text-5xl tracking-tight mb-6 leading-tight text-gray-900 dark:text-white">
              {about.title}
            </h2>
            ...
            <div className="space-y-8">
              {about.items?.map((item, i) => (
                <div key={i} className="flex gap-5 group">
                  <div className="shrink-0 w-14 h-14 rounded-2xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center shadow-sm group-hover:bg-smart-green-600 group-hover:border-smart-green-600 transition-colors">
                    <item.icon className="w-6 h-6 text-smart-green-600 group-hover:text-white transition-colors" />
                  </div>
                  <div className="pt-1">
                    <h4 className="font-bold text-lg text-gray-900 dark:text-white mb-1">{item.label}</h4>
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        <div className="relative bg-gray-900 dark:bg-white rounded-[3rem] py-24 px-8 text-center overflow-hidden shadow-2xl">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(59,109,17,0.3),transparent_60%)]" />
          <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMiIgY3k9IjIiIHI9IjEiIGZpbGw9InJnYmEoMjU1LDI1NSwyNTUsMC4wNykiLz48L3N2Zz4=')] dark:bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMjAiIGhlaWdodD0iMjAiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PGNpcmNsZSBjeD0iMiIgY3k9IjIiIHI9IjEiIGZpbGw9InJnYmEoMCwwLDAsMC4wNykiLz48L3N2Zz4=')] opacity-50" />
          
          <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="font-fraunces font-black text-5xl md:text-7xl mb-6 tracking-tighter text-white dark:text-gray-900">
              {ctaSection.title}
            </h2>
      ...
      <footer className="max-w-7xl mx-auto px-6 pb-12 pt-20 border-t border-gray-200 dark:border-gray-800">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-sm font-bold text-gray-500 dark:text-gray-400">
            <a href="#" className="hover:text-smart-green-600 dark:hover:text-smart-green-400 transition-colors">Platform</a>
            <a href="#" className="hover:text-smart-green-600 dark:hover:text-smart-green-400 transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-smart-green-600 dark:hover:text-smart-green-400 transition-colors">Terms of Service</a>
            <a href="#" className="hover:text-smart-green-600 dark:hover:text-smart-green-400 transition-colors">Contact Support</a>
          </div>
          <div className="flex gap-4">
            {[Leaf, Cannabis, LeafyGreen].map((Icon, i) => (
              <button key={i} className="w-10 h-10 flex items-center justify-center bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl text-gray-400 hover:text-smart-green-600 hover:border-smart-green-600 dark:hover:text-smart-green-400 dark:hover:border-smart-green-400 transition-all shadow-sm">
